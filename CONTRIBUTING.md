...
Create a [Github Issue](https://github.com/jose-luis-rs/r3bdockers/issues/new/choose).

## Contributing code

Create a [Github Pull Request](https://github.com/jose-luis-rs/r3bdockers/compare):

1. By default, develop against the [`main`](https://github.com/jose-luis-rs/r3bdockers/tree/main)
...
[G.2](https://github.com/jose-luis-rs/r3bdockers/blob/main/CONTRIBUTING.md#g.2-adopted-c++-core-guidelines)
...
* If a `scope` is used, prefer the library name (first directory level below
  `R3BDockers/`), e.g. `fix(base):` or `feat(os):`

### G.4 Signed Commits and Tags
